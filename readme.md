...
To import the library copy and paste **dbConnection.py** into your project and type the following instruccion to be able to use **PostgreSQL** class:
```python
...
# How PostgreSQL classs work out
